...
export class AppComponent {
  ...
  constructor() {
    ...
    //iki farklı observable yapının datalarını birleştirmemizi sağlıyor
    otherOf.pipe(mergeMap(value => myArray.pipe(delay(5000), map(number => value + number)))).subscribe(data=>{
      console.log(data);
    });
  }
